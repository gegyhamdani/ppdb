<section id="main-content">
	<section class="wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header"><i class="fa fa-file-text-o"></i> Data Peminatan</h3>
				<ol class="breadcrumb">
					<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
					<li><i class="icon_document_alt"></i>Data Master</li>
					<li><i class="fa fa-file-text-o"></i>Data Peminatan</li>
				</ol>
			</div>
		</div>
    	<div class="row">
            	...
            	<div class="kotak">
					<form>
 						<div class="form-group">
 				 			<label for="nama">Nama Peminatan</label>
 				 			<input type="text" class="form-control" required>
						</div>
						<input name="save" type="submit" class="btn btn-success" value="Tambah">
					</form>
				</div>
			</div>
		</div>
