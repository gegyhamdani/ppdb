<?php	
	...
	$asal->setIdpendaftar($_GET['id_pendaftar']);
	$asal->setAsal($_POST['nama_sekolah'], $_POST['status_sekolah'], $_POST['alamat_sekolah'], $_POST['tahun_lulus'], $_POST['no_izasah']); //--->Pengaksesan Method
